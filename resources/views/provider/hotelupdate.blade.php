 ...
 @section('content') 
  <form class="form-horizontal" action="{{ route('provider.hotel.update.post') }}" method="POST">
  ...
  <fieldset>
    ...
    <div class="form-group">
                    ...
                    <div class="col-lg-10">
                     <input type="text" class="form-control" id="inputEmail" placeholder="Price/Night">
                    </div>
    </div>
    <div class="form-group">
