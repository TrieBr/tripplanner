 ...
 <table class="table table-striped table-hover ">
  ...
  <?php foreach($results as $result) { ?>
    <tr>
      ...
      <td>{{$result[2]}}</td>
      <td style="text-align: center;" style="background: white;" rowspan="2"><a href="{{ route('flight.book', $result['FlightNo']) }}"><button class="btn btn-primary btn-xs" type="button">Book Now!</button></a></td>
